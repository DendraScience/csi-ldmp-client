...
exports.XMLRecordParser = exports.FrameParser = void 0;
...
class FrameParser extends _stream.Transform {
  ...
  _transform(chunk, encoding, callback) {
    ...
    try {
      ...
      console.error('Error [FrameParser._transform]:', {
        err
      });
    }
...
class XMLRecordParser extends _stream.Transform {
  ...
  _transform(chunk, encoding, callback) {
    ...
    try {
      ...
      console.error('Error [XMLRecordParser._transform]:', {
        err,
        obj
      });
    }
